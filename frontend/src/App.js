...
import NotificationsPage from './pages/administrador/notificacoes/notifications';
  ...
  return (
    <Provider store={Store}>
      <Router>
        ...
        <Route
          path={'/agendamento_adm'}
          component={AgendamentosAdministrador}
        />
