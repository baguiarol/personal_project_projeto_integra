...
import ModalNewProfissional from '../../../assets/component/modals/administrativo/modal_new_profissional/modal_new_profissional';
...
const ProfissionaisPage = (props) => {
  ...
  return (
    <div>
      <ModalAddCredito
        close={() => setOpenModalCreditos(false)}
        show={openModalCreditos}
      />
