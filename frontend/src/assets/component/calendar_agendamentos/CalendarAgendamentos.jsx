...
const fillHoras = (sabado) => {
  ...
  if (sabado) [horaInicial, horaFinal] = [8, 13];
...
const CalendarAgendamentos = (props) => {
  const [horas, setHoras] = React.useState(
    fillHoras(props.dateSelected.getDay() === 6)
  );
    ...
    <div className={'calendar_agendamentos_container'}>
      <h1 style={{ display: 'flex' }}>
        <span
          onClick={() => {
            props.selectDate(
              moment(props.dateSelected).subtract(1, 'day').toDate()
            );
          }}
                      ...
                      if (isMonthly) {
                        ...
                        // LEGACY ----------- FAVOR NÃO EXCLUIR, apesar de parecer que precise.
                          ...
                          if (
                            ...
                            agnd.horasCanceladas[1] === hora.value &&
